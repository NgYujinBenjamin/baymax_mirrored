...
public class BaySchedule2{
    ...
    public BaySchedule2(ArrayList<Product> allProduct, HashMap<String, Integer> quarterHC, Integer maxBays, Integer maxPreBuild){
     ...
     */
    private void bayAssignment (Product p, Integer maxPreBuild){
