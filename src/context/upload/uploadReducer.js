...
export default (state, action) => {
    switch(action.type) {
        ...
        case RESCHEDULE_RESULT_ERROR:
            return {
                ...state,
                bays: action.payload.bays,
                minGap: action.payload.minGap,
                maxGap: action.payload.maxGap,
